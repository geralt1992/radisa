  ...
  return (
    <div id="add_students">
      ...
      <div className='flex flex-col justify-center items-center mt-28'>
        <h1 className="mb-4 text-4xl font-bold tracking-wide text-gray-600 font-mono ">Dodaj učenika</h1>
        <p className="mb-6 mt-2 text-xl font-light leading-relaxed text-gray-600 lg:text-md sm:px-16">Ovdje možete dodati novog učenika</p>
      </div>
