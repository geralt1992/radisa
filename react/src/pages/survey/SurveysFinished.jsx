    ...
    <div id="finished_surveys" className='bg-gray-100 py-16 px-4 min-h-screen'>
      <ToastContainer
        ...
        <div className='flex flex-col justify-center items-center mt-12'>
            <h1 className="mb-4 text-4xl font-bold tracking-wide text-gray-600 font-mono ">Završeni upitnici</h1>
            <p className="mb-6 mt-2 text-xl font-light leading-relaxed text-gray-600 lg:text-md sm:px-16">Ovdje možete dopiti pristup rezultatima pojedinog upitnika</p>
          </div>
